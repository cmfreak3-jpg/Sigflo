...
export function LandingFeatures() {
  return (
    <section
      ...
      className="scroll-mt-24 bg-landing-mid px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-32"
    >
        ...
        <div className="mt-16 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f, i) => (
            <ScrollReveal key={f.title} delay={0.07 * i}>
              ...
              >
                <div className="pointer-events-none absolute -right-8 -top-8 h-28 w-28 rounded-full bg-landing-accent/12 blur-3xl transition-opacity group-hover:opacity-100" />
