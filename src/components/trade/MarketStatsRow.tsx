...
export function MarketStatsRow({ model }: { model: TradeViewModel }) {
  ...
  return (
    <div className="flex items-center gap-4 overflow-x-auto whitespace-nowrap text-xs text-sigflo-muted [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
